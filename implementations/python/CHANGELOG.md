...
### Fixed
- Python 3.8 compatibility in data_generator.py (numpy.typing import)
- Type annotation compatibility for older Python versions
...
[1.0.2]: https://github.com/umitkavala/zeroc/releases/tag/v1.0.2
